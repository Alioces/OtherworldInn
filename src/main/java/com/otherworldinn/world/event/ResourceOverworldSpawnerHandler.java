 ...
 * 资源主世界生物生成处理器
 *
 * <p>负责在资源主世界中手动执行原版主世界的特殊生物生成机制， 包括：巡逻队、幻翼、猫、僵尸围城、流浪商人。
 */
    ...
    public static void onLevelTick(LevelTickEvent.Post event) {
        ...
        if (level.dimension() == TownDimensions.RESOURCE_OVERWORLD_LEVEL) {
                            ...
                            l -> {
                                ...
                                if (l.getLevelData()
                                    ...
                                    OtherworldInn.LOGGER.warn(
                                            "Failed to add WanderingTraderSpawner: LevelData is not ServerLevelData");
                                }

                                OtherworldInn.LOGGER.info(
                                        "Initialized custom spawners for Resource Overworld");
                                return list;
                            });
            ...
            boolean spawnEnemies =
                    level.getLevelData()
                            .getGameRules()
                            .getBoolean(net.minecraft.world.level.GameRules.RULE_DOMOBSPAWNING);
            boolean spawnFriendlies =
                    level.getLevelData()
                            .getGameRules()
                            .getBoolean(
                                    net.minecraft.world.level.GameRules
                                            .RULE_DOMOBSPAWNING); // 简化处理，通常这也受游戏规则控制
