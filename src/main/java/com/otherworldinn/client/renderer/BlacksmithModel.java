...
public class BlacksmithModel extends HierarchicalModel<BlacksmithEntity> implements ArmedModel {
    ...
    public void setupAnim(
        ...
        this.animate(entity.idleAnimationState, BlacksmithAnimation.LOOP, ageInTicks);
    }
